...
- Repo notebook source: [`training/committee_grpo_colab.ipynb`](./training/committee_grpo_colab.ipynb)
- HF Jobs launcher: [`training/launch_hf_job.py`](./training/launch_hf_job.py)
- Primary HF Jobs artifact bundle: [hf-job-20260425-070718](https://huggingface.co/datasets/anupamagarwal001/amc-allocator-job-artifacts/tree/main/hf-job-20260425-070718)
- 8-step comparison artifact bundle: [hf-job-20260425-8step](https://huggingface.co/datasets/anupamagarwal001/amc-allocator-job-artifacts/tree/main/hf-job-20260425-8step)
